...
import { removeAdminToken } from '@/lib/admin-auth-client';
import { 
  Menu, 
  Bell, 
  User, 
    ...
    <header className="sticky top-0 z-20 bg-white/95 backdrop-blur-sm border-b border-cinza-claro">
      <div className="flex items-center justify-between h-16 px-4 lg:px-6">
        <div className="flex items-center gap-4">
          ...
          {title && (
            <h1 className="text-lg font-semibold text-cinza-escuro">
              {title}
            </h1>
          )}
        </div>
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="relative">
            ...
            >
              <div className="w-8 h-8 bg-verde-oliva rounded-full flex items-center justify-center">
