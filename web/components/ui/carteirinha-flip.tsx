    ...
    <div className={cn("w-full max-w-md mx-auto", className)}>
      ...
      >
        ...
        >
            ...
            <div className="p-4 md:p-5">
              <div className="flex gap-4">
                <div className="flex-shrink-0">
                  <div className="w-20 h-24 md:w-24 md:h-28 rounded-xl bg-gradient-to-br from-gray-50 to-gray-100 border-2 border-[#3FA174] flex items-center justify-center overflow-hidden">
                    {associado.foto ? (
                      <img 
                        src={associado.foto} 
          ...
          >
            <div className="absolute top-10 left-0 right-0 h-12 bg-[#1d1d1f]" />
            
            <div className="h-full flex flex-col p-4 md:p-5 pt-28">
              <div className="bg-white/95 rounded-xl p-4 mb-4 shadow-lg">
                <div className="flex items-center justify-between">
                  <div className="flex-1">
                    <p className="text-[9px] text-gray-500 uppercase tracking-wider mb-1">Plano Ativo</p>
                    <p className="text-sm font-bold text-[#1B4332]">{associado.plano}</p>
                    <p className="text-[10px] text-gray-500 mt-1">Válido até {associado.validade}</p>
                  </div>
                  <div className="w-20 h-20 bg-[#1d1d1f] rounded-xl flex items-center justify-center p-2">
                    <div className="w-full h-full bg-white rounded-lg flex items-center justify-center">
                      <QrCode className="w-12 h-12 text-[#1d1d1f]" />
                    </div>
                  </div>
                </div>
              </div>
              ...
              {associado.cpf && (
                <div className="bg-white/20 rounded-lg p-3 mb-4">
                  <p className="text-[9px] text-white/60 uppercase tracking-wider">CPF</p>
                  <p className="text-white font-mono text-sm">{associado.cpf.replace(/(\d{3})(\d{3})(\d{3})(\d{2})/, '$1.***.***-$4')}</p>
                </div>
              )}
              ...
              <div className="flex-1 flex flex-col justify-end">
                <div className="text-center space-y-2">
                  <div className="flex items-center justify-center gap-2">
                    ...
                    <p className="text-white/90 text-[11px] font-medium">Documento Oficial ABRACANM</p>
                  </div>
                  <p className="text-white/60 text-[9px] leading-relaxed px-4">
                    Esta carteira é pessoal e intransferível. O uso indevido está sujeito às penalidades previstas em lei.
                  </p>
