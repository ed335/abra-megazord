    ...
    <div className={cn("w-full", className)}>
      ...
      <div className="hidden md:block">
        <div className="relative max-w-4xl mx-auto">
          {/* Progress Line */}
          <div className="absolute top-8 left-0 right-0 h-0.5 bg-[#e5e5e5]">
            <motion.div 
              className="h-full bg-gradient-to-r from-[#6B7C59] to-[#A8C686]"
              initial={{ width: "0%" }}
              ...
              >
                ...
                <motion.div
                  className={cn(
                    ...
                    index <= activeIndex 
                      ? "bg-[#6B7C59] text-white shadow-lg shadow-[#6B7C59]/30" 
                      : "bg-white border-2 border-[#e5e5e5] text-[#86868b] group-hover:border-[#6B7C59]/50"
                  )}
                ...
                >
                  ...
                  {index === activeIndex && (
                    <motion.div
                      className="absolute inset-0 rounded-full border-2 border-[#6B7C59]"
                ...
                <div className="mt-4 text-center max-w-[120px]">
                  <span className="text-xs text-[#6B7C59] font-medium">{item.date}</span>
                  <h4 className={cn(
                    "text-sm font-semibold mt-1 transition-colors",
                    index <= activeIndex ? "text-[#1d1d1f]" : "text-[#86868b]"
                  )}>
                    {item.title}
                  </h4>
                </div>
          ...
          >
            <div className="inline-flex items-center gap-3 bg-white rounded-2xl px-8 py-6 shadow-lg border border-[#e5e5e5]">
              ...
              <div className="text-left">
                <h3 className="text-lg font-semibold text-[#1d1d1f]">{items[activeIndex].title}</h3>
                <p className="text-sm text-[#86868b]">{items[activeIndex].description}</p>
              </div>
            </div>
          </motion.div>
        </div>
      ...
      <div className="md:hidden">
        <div className="relative pl-8">
          {/* Vertical Line */}
          <div className="absolute left-3 top-0 bottom-0 w-0.5 bg-[#e5e5e5]">
            <motion.div 
              className="w-full bg-gradient-to-b from-[#6B7C59] to-[#A8C686]"
              initial={{ height: "0%" }}
          ...
          <div className="space-y-8">
            {items.map((item, index) => (
              ...
              >
                {/* Circle Marker */}
                <div className="absolute -left-8 top-0 w-6 h-6 rounded-full bg-[#6B7C59] flex items-center justify-center text-white text-xs font-bold shadow-md">
                  {index + 1}
                </div>
                ...
                <div className="bg-white rounded-xl p-4 border border-[#e5e5e5] shadow-sm hover:shadow-md hover:border-[#6B7C59]/30 transition-all">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <span className="text-xs text-[#6B7C59] font-medium">{item.date}</span>
                      <h4 className="text-base font-semibold text-[#1d1d1f] mt-0.5">{item.title}</h4>
