              ...
              filteredPacientes.map((paciente, i) => (
                ...
                >
                  <div className="flex items-start gap-4">
                    <div className="w-12 h-12 bg-[#3FA174]/10 rounded-full flex items-center justify-center flex-shrink-0">
                      {paciente.fotoUrl ? (
                        <img src={paciente.fotoUrl} alt="" className="w-12 h-12 rounded-full object-cover" />
                      ) : (
            ...
            {selectedPaciente ? (
              ...
              >
                <div className="p-4 border-b border-gray-100">
                  <div className="flex items-center gap-3">
                    <div className="w-16 h-16 bg-[#3FA174]/10 rounded-full flex items-center justify-center">
                      {selectedPaciente.fotoUrl ? (
                        <img src={selectedPaciente.fotoUrl} alt="" className="w-16 h-16 rounded-full object-cover" />
                      ) : (
